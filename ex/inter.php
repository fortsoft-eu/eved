...
?>
    ...
    <input type="text" id="table-filter" class="js-table-filter" data-table-filter="interactions-table" value="<?php echo html(getQuickTableFilterValue("table-filter")); ?>">
    ...
    <span class="table-record-count js-table-record-count" data-table-count="interactions-table" aria-live="polite"><?php echo count($aCommunicationRows); ?></span>
  </p>
