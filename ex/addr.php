...
?>
    ...
    <span class="table-record-count js-table-record-count" data-table-count="addresses-table" aria-live="polite"><?php echo $iRenderThrobberRowCount; ?></span>
  </p>
...
foreach (getAddressTypes() as $sAddressType) {
    echo "            <option value=\"" . html($sAddressType) . "\">" . html(ucwords(str_replace("_", " ", $sAddressType))) . "</option>\n";
}
