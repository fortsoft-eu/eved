...
foreach ($aContactRows as $aContactRow) {
    ...
    if (!$aContactRow["subjects"]) {
        echo "      <tr>\n"
            ...
            . nxRenderContactValue($aContactRow["contact_type"], $aContactRow["contact_value"], true, true)
            . $sContactActions
            . "</td>\n"
