...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["action"]) && $_POST["action"] == "update_shared_contact") {
    ...
    try {
        ...
        $blContactValueChanged = $aContact["current_contact_value"] != $sContactValue;
...
<body data-show-computed-subject-name="1" data-chromium="<?php echo isChromiumBased() ? "1" : "0"; ?>">
...
?>
    ...
    <span class="table-record-count js-table-record-count" data-table-count="contacts-table" aria-live="polite"><?php echo $iRenderThrobberRowCount; ?></span>
  </p>
