CREATE TABLE `ex_contact_types` (
  ...
  `contact_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `ex_contacts` (
  ...
  KEY `ix_ex_contacts_type` (`contact_type_id`) USING BTREE,
...
CREATE TABLE `ex_subjects` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `subject_type` enum('person','organization','service','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `legacy_id` int(10) unsigned DEFAULT NULL,
  `created_at` datetime(6) NOT NULL DEFAULT current_timestamp(6),
  `updated_at` datetime(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6),
...
CREATE TABLE `ex_subject_addresses` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `subject_id` int(10) unsigned NOT NULL,
  `address_type` enum('main','home','cottage','work','office','registered','delivery','billing','foreign','temporary','old','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'main',
  ...
  `updated_at` datetime(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `ix_ex_subject_addresses_subject_id` (`subject_id`),
...
CREATE TABLE `ex_subject_contacts` (
  ...
  KEY `ix_ex_subject_contacts_subject_id` (`subject_id`) USING BTREE,
...
CREATE TABLE `ex_subject_nicknames` (
  ...
  `updated_at` datetime(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `ix_ex_subject_nicknames_subject_id` (`subject_id`),
...
CREATE TABLE `ex_subject_notes` (
  ...
  `updated_at` datetime(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `ix_ex_subject_notes_subject_id` (`subject_id`),
