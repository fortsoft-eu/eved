...
function renderLoginPageAndExit($sTokenName, $sMessage = "") {
    ...
    echo "<!DOCTYPE html>\n",
        ...
        "  <link rel=\"icon\" type=\"image/x-icon\" href=\"" . $sBaseUrl . "gfx/favicon.ico\">\n",
        "  <link rel=\"shortcut icon\" type=\"image/x-icon\" href=\"" . $sBaseUrl . "gfx/favicon.ico\">\n",
        "  <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style.css")) . "\" title=\"Original\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-graphite.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-graphite.css")) . "\" title=\"Graphite\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-midnight.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-midnight.css")) . "\" title=\"Midnight\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-slate.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-slate.css")) . "\" title=\"Slate\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-sepia.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-sepia.css")) . "\" title=\"Sepia\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-sand.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-sand.css")) . "\" title=\"Sand\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-forest.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-forest.css")) . "\" title=\"Forest\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-moss.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-moss.css")) . "\" title=\"Moss\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-ocean.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-ocean.css")) . "\" title=\"Ocean\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-ice.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-ice.css")) . "\" title=\"Ice\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-lavender.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-lavender.css")) . "\" title=\"Lavender\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-rose.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-rose.css")) . "\" title=\"Rose\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-copper.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-copper.css")) . "\" title=\"Copper\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-burgundy.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-burgundy.css")) . "\" title=\"Burgundy\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-monochrome.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-monochrome.css")) . "\" title=\"Monochrome\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-high-contrast.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-high-contrast.css")) . "\" title=\"High Contrast\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-soft.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-soft.css")) . "\" title=\"Soft\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-paper.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-paper.css")) . "\" title=\"Paper\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-terminal.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-terminal.css")) . "\" title=\"Terminal\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-cobalt.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-cobalt.css")) . "\" title=\"Cobalt\">\n",
        "  <link rel=\"alternate stylesheet\" type=\"text/css\" href=\"" . $sBaseUrl . "css/style-plum.css?sToken=" . dechex(filemtime($sScriptDirectory . "/css/style-plum.css")) . "\" title=\"Plum\">\n",
